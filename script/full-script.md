...
## Slide 21 - Modelo + ferramenta + CLI
Tempo sugerido: ~0:55

E aí vem a correlação que importa. De um lado, frontier model melhorando em thinking entre chamadas de ferramenta. Do outro, o suporte de ferramenta melhorando junto: contexto, busca, execução, patch, shell, MCP. E por cima disso, Claude Code e Codex levando esse pacote pro terminal, pro editor e pra nuvem. Quando essas três camadas alinharam ao mesmo tempo, dezembro de 2025 virou mês de experimento sério.
...
## Slide 31 - Prompt único é pra demo
Tempo sugerido: ~0:55
...
## Slide 33 - Não terceirize seu julgamento
Tempo sugerido: ~0:45
